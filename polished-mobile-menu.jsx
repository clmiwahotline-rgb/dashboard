...
const M_MENU_ITEMS = [
  ...
  { key: "factory", icon: "🏭", label: "工場報告", sub: "生産性・工数", kind: "view", target: "factory", accent: "#8430ce", bg: "#f3e8fd" },
...
const MMenu = ({ go, registerHeader, registerFab }) => {
  ...
  return (
    <div>
      ...
      <div className="m-menu-note">クレーム／ありがとう／共有ボード／料金表はスマホ画面で操作できます。</div>
