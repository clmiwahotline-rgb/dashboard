  ...
  function build() {
    ...
    css.textContent = [
      ...
      "body{",
        ...
        "padding-bottom:calc(var(--mf-h) + env(safe-area-inset-bottom,0px) + 4px) !important;",
      "}",
      ...
      "#mf-tabbar{",
        ...
        "height:calc(var(--mf-h) + env(safe-area-inset-bottom,0px));padding-bottom:env(safe-area-inset-bottom,0px);",
        "display:flex;",
